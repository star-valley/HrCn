...
extern IplImage* EdgeDtc(IplImage* bnr);
extern CvSeq* ContourExtr(IplImage* edge, IplImage* imcontour);
extern vector<float> HullDscr(CvSeq* contour, CvPoint* Dweb, IplImage* imhull, IplImage* imdefects);
extern Gesture GesDtm(vector<float> cwdpths, CvPoint* Dweb, CvSeq* contour);
